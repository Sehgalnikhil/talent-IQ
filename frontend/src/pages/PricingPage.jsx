            ...
            <div className="max-w-7xl mx-auto px-6 pt-40 pb-32 relative z-10">
                ...
                <div className="text-center space-y-6 mb-24">
                    ...
                    <motion.h1 
                        ...
                        className="text-7xl font-black italic tracking-tighter bg-gradient-to-r from-white via-white to-white/40 bg-clip-text text-transparent"
                    >
                        POWER YOUR GROWTH_
                    </motion.h1>
                ...
                >
                    <div className="px-10 py-6 rounded-[32px] bg-white/5 border border-white/10 backdrop-blur-3xl flex items-center gap-8 shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                    {TIERS.map((tier, idx) => (
                        <motion.div
                            ...
                            className={`group relative p-1 rounded-[48px] transition-all duration-500 hover:scale-[1.02] ${tier.popular ? 'bg-gradient-to-br from-primary via-secondary to-accent shadow-2xl shadow-primary/20' : 'bg-white/10 hover:bg-white/20'}`}
                        >
                            <div className="h-full w-full bg-[#080808] rounded-[44px] p-10 flex flex-col items-start overflow-hidden relative">
                                {/* TIER SHIMMER */}
                                ...
                                <div className={`size-16 rounded-[22px] bg-gradient-to-br ${tier.color} flex items-center justify-center mb-10 shadow-xl ring-8 ring-white/5`}>
                                ...
                                <div className="space-y-6 mb-12 w-full">
                                    <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between group-hover:border-primary/20 transition-all">
                                ...
                                <div className="space-y-4 mb-20 flex-1">
                                    {tier.features.map(f => (
                                        <div key={f} className="flex gap-4 items-center group/item transition-all">
                                            <div className="size-5 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover/item:border-primary/40 transition-all">
                                ...
                                <button 
                                    ...
                                    className={`w-full h-20 rounded-[28px] font-black text-xs tracking-widest uppercase flex items-center justify-center gap-3 transition-all duration-500 overflow-hidden relative group/btn ${tier.popular ? 'bg-primary text-primary-content hover:scale-[0.98]' : 'bg-white/5 hover:bg-white/10 border border-white/10'}`}
                                >
                ...
                <motion.div 
                    ...
                    className="grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-white/10 pt-20"
                >
                    {[
                ...
                {showSuccessModal && (
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-lg bg-[#0a0a0a] border border-primary/30 rounded-[48px] p-12 overflow-hidden shadow-[0_0_100px_rgba(var(--color-primary),0.2)]"
                        >
                            {/* AMBIENT EFFECTS */}
